          ...
          <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left space-y-6">
              ...
              <p className="text-xl text-white/90 max-w-lg mx-auto lg:mx-0">
                Register for administrative access to oversee platform operations and ensure quality standards.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto lg:mx-0">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 text-center">
                  <div className="text-2xl font-bold text-white">Full</div>
                  <div className="text-white/80 text-sm">Access Control</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 text-center">
              ...
              <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/30 rounded-lg p-4 max-w-lg mx-auto lg:mx-0">
                <div className="flex items-center gap-2 text-red-200 text-sm">
                  ...
                  Admin registration requires approval. All activities are logged for security.
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center lg:justify-end">
              <SignupForm
                ...
                description="Request administrative access to the platform"
                userType="admin"
              />
            </div>
          </div>
